...
<body>
    <div class="contProfile">
        <form action="<?= ROOT_PATH ?>" method="post" class="centerProfile">
            <h2>Editar perfil</h2>
            <div class="fotoArea">
                <img src="views/images/<?= $_SESSION['foto'] ?>" alt="Perfil">
                <label for="foto">
        ...
        <div class="centerMain">
            <div class="contUsers">
                <?php foreach($users as $value) { ?>
                    <div class="user">
                        <img src="views/images/<?= $value['foto'] ?>" alt="Perfil" class="fotoPerfil">
            ...
            <div class="contChat">
                <div class="contPerfil">
                    <img src="views/images/ico-fotoperfil.png" alt="Perfil" class="fotoPerfil">
